...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactCond = __webpack_require__(159);
	...
	var ExampleApplication = (function (_React$Component) {
	  ...
	  function ExampleApplication(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ExampleApplication).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cond = _react2['default'].createClass({
		displayName: 'Cond',
		...
		componentWillReceiveProps: function componentWillReceiveProps(_ref4) {
			...
			var nextCompare = _ref4.compare;
			var _props = this.props;
			var compare = _props.compare;
		...
		render: function render() {
			...
			var _findFirst = findFirst(normalized, function (_ref5) {
				var _ref52 = _slicedToArray(_ref5, 2);

				var condition = _ref52[0];
				var result = _ref52[1];
				return condition(value);
			});

			var _findFirst2 = _slicedToArray(_findFirst, 2);

			var condition = _findFirst2[0];
			var result = _findFirst2[1];
	...
	exports.T = T;
	var value = function value(name, condition) {
		return function (val) {
	...
	exports.value = value;
	var Clause = _react2['default'].createClass({
		displayName: 'Clause',
	...
	var wrap = function wrap(fn) {
		...
		return function () {
			...
			if (args.length >= count + 1) {
				...
				return value(_name, fn.apply(undefined, _toConsumableArray(params)));
			} else {
	...
	var eq = wrap(function (x) {
		return function (y) {
			return x === y;
		};
	});
	exports.eq = eq;
	var gt = wrap(function (x) {
		return function (y) {
			return y > x;
		};
	});
	exports.gt = gt;
	var lt = wrap(function (x) {
		return function (y) {
			return y < x;
		};
	});
	exports.lt = lt;
	var gte = wrap(function (x) {
		return function (y) {
			return y >= x;
		};
	});
	exports.gte = gte;
	var lte = wrap(function (x) {
		return function (y) {
			return y <= x;
		};
	});
	exports.lte = lte;
	var between = wrap(function (x, y) {
		return function (val) {
			return x < val && val < y;
		};
	}, 2);
